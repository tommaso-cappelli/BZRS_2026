...
outdir = '/scicore/home/nimwegen/cappel0001/BZRS_PROJECT/breseq_test/score1_freq10/'+ sample_taken['sample_name'] + '-breseq'
...
cmd = ["breseq", "-p", "--polymorphism-score-cutoff", "1", "--polymorphism-frequency-cutoff", "0.1","-r", ref, "-o", outdir, "-j", "1", in1, in2]
