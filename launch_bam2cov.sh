...
#SBATCH --qos=6hours
#SBATCH --output=/scicore/home/nimwegen/cappel0001/BZRS_PROJECT/breseq_test/stdpar/txt_outputs/output_BAM2COV_%A_%3a.txt
#SBATCH --error=/scicore/home/nimwegen/cappel0001/BZRS_PROJECT/breseq_test/stdpar/errors/err_BAM2COV_%A_%3a.txt
...
script_path='/scicore/home/nimwegen/cappel0001/BZRS_PROJECT/breseq_test/input_files/bamcoverage.py'
